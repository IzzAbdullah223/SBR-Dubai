...
export const getSavedRoutes = async (req: Request, res: Response): Promise<void> => {
  // auth here later
  try {
...
export const createSavedRoute = async (req: Request, res: Response): Promise<void> => {
  // auth here later
  try {
    const userId = req.user?.id as number;
...
export const deleteSavedRoute = async (req: Request, res: Response): Promise<void> => {
  // auth here later
  try {
    const userId = req.user?.id as number;
