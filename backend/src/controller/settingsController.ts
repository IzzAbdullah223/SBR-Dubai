...
export const getFavoriteStops = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const userId = req.userId!;
...
export const addFavoriteStop = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const userId = req.userId!;
...
export const removeFavoriteStop = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const userId = req.userId!;
...
export const clearSavedRoutes = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const userId = req.userId!;
