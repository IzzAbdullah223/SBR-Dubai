...
export const getFavoriteStops = async (req: Request, res: Response): Promise<void> => {
  // auth here later
  try {
    const userId = req.user?.id as number;
...
export const addFavoriteStop = async (req: Request, res: Response): Promise<void> => {
  // auth here later
  try {
    const userId = req.user?.id as number;
...
export const removeFavoriteStop = async (req: Request, res: Response): Promise<void> => {
  // auth here later
  try {
    const userId = req.user?.id as number;
...
export const clearSavedRoutes = async (req: Request, res: Response): Promise<void> => {
  // auth here later
  try {
    const userId = req.user?.id as number;
