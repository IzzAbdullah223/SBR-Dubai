...
// @ts-nocheck 
/*
 * This file exports the `VirtualWallet` model and its related types.
 *
...
export type GetVirtualWalletAggregateType<T extends VirtualWalletAggregateArgs> = {
      [P in keyof T & keyof AggregateVirtualWallet]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateVirtualWallet[P]>
    : Prisma.GetScalarType<T[P], AggregateVirtualWallet[P]>
}
...
export type GetVirtualWalletGroupByPayload<T extends VirtualWalletGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<VirtualWalletGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof VirtualWalletGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], VirtualWalletGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], VirtualWalletGroupByOutputType[P]>
      }
    >
  >
...
export type VirtualWalletCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<VirtualWalletFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface VirtualWalletDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['VirtualWallet'], meta: { name: 'VirtualWallet' } }
  /**
   ...
   * })
  **/
  count<T extends VirtualWalletCountArgs>(
    args?: Prisma.Subset<T, VirtualWalletCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], VirtualWalletCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends VirtualWalletGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, VirtualWalletGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetVirtualWalletGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
