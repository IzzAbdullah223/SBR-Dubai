...
export type RouteStopWhereInput = {
    ...
    stopSequence?: Prisma.IntFilter<"RouteStop"> | number;
...
export type RouteStopScalarWhereWithAggregatesInput = {
    ...
    stopSequence?: Prisma.IntWithAggregatesFilter<"RouteStop"> | number;
    routeId?: Prisma.IntWithAggregatesFilter<"RouteStop"> | number;
};
export type RouteStopCreateInput = {
    stopId: string;
    stopSequence: number;
    route: Prisma.BusRouteCreateNestedOneWithoutStopsInput;
};
...
export type RouteStopUpdateInput = {
    ...
    stopSequence?: Prisma.IntFieldUpdateOperationsInput | number;
    route?: Prisma.BusRouteUpdateOneRequiredWithoutStopsNestedInput;
};
...
export type RouteStopOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "stopId" | "stopSequence" | "routeId", ExtArgs["result"]["routeStop"]>;
...
export interface RouteStopFieldRefs {
    ...
    readonly stopSequence: Prisma.FieldRef<"RouteStop", 'Int'>;
